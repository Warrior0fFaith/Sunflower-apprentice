    ...
    if (pref === config.prefix) {
	    ...
	    msg.channel.send("", {file: "http://content.forums.previously.tv/monthly_2017_11/psych_det.gif.0c328743a39d9bb92ed5291d126e865f.gif"});
	       ...
	       var headache = new Discord.RichEmbed()
               ...
               .addField('__(ﾉ◕ヮ◕)ﾉ*:･ﾟ✧__', '- If you have almonds take a handful or more and eat them\n' + '- Acetaminophen or Aspirin\n' + '- You chould be dehydrated, so make sure you drink water\n' + '- If you have a migraine place a cold pack on your forehead. If you do not have those you could place ice cubes wrapped in a towel, a bag of frozen peas, or even a shower may lessen the pain. Keep the compress on your head for 15mins, then take a break for 15min\n' + '- If you have a sinus headache hold a warm cloth to the area that hurts\n' + '- A warm shower might also do the trick\n' + '- Ginger Tea\n')
               .setColor(0x990000);
		...
		msg.channel.send("", {file: random.select('dance')});
                ...
                msg.channel.send("", {file: random.select('memes')});
		...
		.addField('__Prefix__ |','.+')
		.addField('__Commands__ |', '- Facedesk / Facepalm [When you need to smack your face on something]\n' + '- Fistbump [*balalalalalala*]\n' + '- Flipflop [Use only for those who need it]\n' + '- Gang [Your fambam]\n' + '- Headache [Have a headache? Feel free to use this command]\n' + '- Hide [Use if you need to hide]\n' + '- Hug [When you want to loaf someone]\n' + '- Hugkirbea [Loaf towards the Kirby]\n' + '- Info [Learn about my commands]\n' + '- Newspaper [For someone who is being a troublemaker]\n' + '- Pillowfight [Want to smack someone? Use this ;3]\n' + '- Ping [Ping pong game]\n' + '- Puns [When you are feeling punny]\n' + '- Thetalk [Use if someone is being a bad boy/girl]\n' + '- Tacos [You can use this when you are in the taco mood]\n' + '- Watergun [When you want to squirt at someone]\n' + '- Food [Use if you are hungry]\n' + '- Tea [Feeling thirsty? Use this to receive tea]\n' + '- Coffee [When you need caffeine]\n' + '- Dance [When you are feeling groovy]\n')
		.setColor(0xEE7600);
