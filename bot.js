    ...
    if (pref === config.prefix) {
	    ...
	    msg.channel.send("", {file: "http://content.forums.previously.tv/monthly_2017_11/psych_det.gif.0c328743a39d9bb92ed5291d126e865f.gif"});
	       ...
	       var headache = new Discord.RichEmbed()
               ...
               .addField('- If you have a migraine place a cold pack on your forehead. If you do not have those you could place ice cubes wrapped in a towel, a bad of frozen peas, or even a shower may lessen the pain. Keep the compress on your hear for 15mins, then take a break for 15mins.')
	       .addField('- If you have a sinus headache hold a warm cloth to the area that hurts')
               .addField('- A warm shower might also do the trick')
               .addField('- Ginger Tea')
               .setColor(0x990000);
